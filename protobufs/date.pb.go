...
func (Person_PhoneType) Descriptor() protoreflect.EnumDescriptor {
	return file_date_proto_enumTypes[0].Descriptor()
}

func (Person_PhoneType) Type() protoreflect.EnumType {
	return &file_date_proto_enumTypes[0]
}
...
func (Person_PhoneType) EnumDescriptor() ([]byte, []int) {
	return file_date_proto_rawDescGZIP(), []int{0, 0}
}
...
var file_date_proto_rawDesc = []byte{
	0x0a, 0x0a, 0x64, 0x61, 0x74, 0x65, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x12, 0x04, 0x74, 0x65,
	0x73, 0x74, 0x1a, 0x1f, 0x67, 0x6f, 0x6f, 0x67, 0x6c, 0x65, 0x2f, 0x70, 0x72, 0x6f, 0x74, 0x6f,
	0x62, 0x75, 0x66, 0x2f, 0x74, 0x69, 0x6d, 0x65, 0x73, 0x74, 0x61, 0x6d, 0x70, 0x2e, 0x70, 0x72,
	0x6f, 0x74, 0x6f, 0x22, 0xb3, 0x02, 0x0a, 0x06, 0x50, 0x65, 0x72, 0x73, 0x6f, 0x6e, 0x12, 0x12,
	...
	0x09, 0x52, 0x05, 0x65, 0x6d, 0x61, 0x69, 0x6c, 0x12, 0x30, 0x0a, 0x06, 0x70, 0x68, 0x6f, 0x6e,
	0x65, 0x73, 0x18, 0x04, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x18, 0x2e, 0x74, 0x65, 0x73, 0x74, 0x2e,
	...
	0x73, 0x74, 0x55, 0x70, 0x64, 0x61, 0x74, 0x65, 0x64, 0x1a, 0x51, 0x0a, 0x0b, 0x50, 0x68, 0x6f,
	...
	0x2e, 0x74, 0x65, 0x73, 0x74, 0x2e, 0x50, 0x65, 0x72, 0x73, 0x6f, 0x6e, 0x2e, 0x50, 0x68, 0x6f,
	...
	0x6c, 0x65, 0x18, 0x01, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x0c, 0x2e, 0x74, 0x65, 0x73, 0x74, 0x2e,
	0x50, 0x65, 0x72, 0x73, 0x6f, 0x6e, 0x52, 0x06, 0x70, 0x65, 0x6f, 0x70, 0x6c, 0x65, 0x42, 0x03,
...
var file_date_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
var file_date_proto_msgTypes = make([]protoimpl.MessageInfo, 3)
var file_date_proto_goTypes = []interface{}{
	(Person_PhoneType)(0),         // 0: test.Person.PhoneType
	(*Person)(nil),                // 1: test.Person
	(*AddressBook)(nil),           // 2: test.AddressBook
	(*Person_PhoneNumber)(nil),    // 3: test.Person.PhoneNumber
	(*timestamppb.Timestamp)(nil), // 4: google.protobuf.Timestamp
}
var file_date_proto_depIdxs = []int32{
	3, // 0: test.Person.phones:type_name -> test.Person.PhoneNumber
	4, // 1: test.Person.last_updated:type_name -> google.protobuf.Timestamp
	1, // 2: test.AddressBook.people:type_name -> test.Person
	0, // 3: test.Person.PhoneNumber.type:type_name -> test.Person.PhoneType
...
func file_date_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_date_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		...
		EnumInfos:         file_date_proto_enumTypes,
